...
trait TransaksiController
{
    ...
    public function index(Request $request)
    {
        ...
        return view($this->filterIndexView('_transaksi.index'), $this->filterSearchViewData($request, [
            'primaryKey' => $pkey,
            'records' => $records,
            'search' => $search,
    ...
    public function create()
    {
        ...
        return view($this->filterCreateView('_transaksi.create'), $this->filterCreateViewData([
            'record' => new $class(),
            'resourceAlias' => $this->getResourceAlias(),
            'resourceRoutesAlias' => $this->getResourceRoutesAlias(),
            'resourceTitle' => $this->getResourceTitle(),
    ...
    public function edit($id)
    {
        ...
        return view($this->filterEditView('_transaksi.edit'), $this->filterEditViewData($record, [
            'primaryKey' => $pkey,
            'record' => $record,
            'resourceAlias' => $this->getResourceAlias(),
            'resourceRoutesAlias' => $this->getResourceRoutesAlias(),
